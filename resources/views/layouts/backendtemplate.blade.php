...
<html>
  <head>
    ...
    <title>Admin Site - @yield('title')</title>
    ...
    <!-- orion icons-->
    <link rel="stylesheet" href="{{ asset('backend_assets/css/orionicons.css') }}">
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="{{ asset('backend_assets/css/style.default.css') }}" id="theme-stylesheet">
  ...
  <body>
    <!-- navbar-->
    <header class="header">
      <nav class="navbar navbar-expand-lg px-4 py-2 bg-white shadow"><a href="#" class="sidebar-toggler text-gray-500 mr-4 mr-lg-5 lead"><i class="fas fa-align-left"></i></a><a href="{{route('dashboard')}}" class="navbar-brand font-weight-bold text-uppercase text-base">Admin Site</a>
        <ul class="ml-auto d-flex align-items-center list-unstyled mb-0">
          ...
          <li class="nav-item dropdown ml-auto"><a id="userInfo" href="http://example.com" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle"><img src="{{asset('backend_assets/img/avatar-6.jpg')}}" alt="Jason Doe" style="max-width: 2.5rem;" class="img-fluid rounded-circle shadow"></a>
            <div aria-labelledby="userInfo" class="dropdown-menu"><a href="#" class="dropdown-item"><strong class="d-block text-uppercase headings-font-family">Wa Toke</strong><small>Master</small></a>
    ...
    <div class="d-flex align-items-stretch">
      <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
              ...
              <li class="sidebar-list-item"><a href="{{route('agents.index')}}" class="sidebar-link text-muted {{ Request::is('admin/agents*') ? 'active' : '' }}"><i class="o-sales-up-1 mr-3 text-gray"></i><span>Agents</span></a></li>
              ...
              <li class="sidebar-list-item"><a href="{{route('leagues.index')}}" class="sidebar-link text-muted {{ Request::is('admin/leagues*') ? 'active' : '' }}"><i class="o-survey-1 mr-3 text-gray"></i><span>Leagues</span></a></li>
              <li class="sidebar-list-item"><a href="{{route('teams.index')}}" class="sidebar-link text-muted {{ Request::is('admin/teams*') ? 'active' : '' }}"><i class="o-survey-1 mr-3 text-gray"></i><span>Teams</span></a></li>
    ...
    <script src="{{ asset('backend_assets/vendor/popper.js/umd/popper.min.js')}}"> </script>
