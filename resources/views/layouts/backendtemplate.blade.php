    ...
    <div class="d-flex align-items-stretch">
      <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
          ...
          <li class="sidebar-list-item"><a href="{{route('bets.index')}}" class="sidebar-link text-muted {{ Request::is('bets*') ? 'active' : '' }}"><i class="o-survey-1 mr-3 text-gray"></i><span>Bets Report</span></a></li>
