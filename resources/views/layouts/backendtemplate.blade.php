    ...
    <div class="d-flex align-items-stretch">
      <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
              ...
              <li class="sidebar-list-item"><a href="{{route('agents.index')}}" class="sidebar-link text-muted {{ Request::is('agents*') ? 'active' : '' }}"><i class="o-sales-up-1 mr-3 text-gray"></i><span>Agents</span></a></li>
              ...
              <li class="sidebar-list-item"><a href="{{route('leagues.index')}}" class="sidebar-link text-muted {{ Request::is('leagues*') ? 'active' : '' }}"><i class="o-survey-1 mr-3 text-gray"></i><span>Leagues</span></a></li>
              <li class="sidebar-list-item"><a href="{{route('teams.index')}}" class="sidebar-link text-muted {{ Request::is('teams*') ? 'active' : '' }}"><i class="o-survey-1 mr-3 text-gray"></i><span>Teams</span></a></li>
